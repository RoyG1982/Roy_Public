...
parser.add_argument ("-p", "--parameter", type = str, required = True, help = "Choose between os_info/cpu_count/cpu_percent\
                     /total_memory, used_memory, free_memory/hd_info/local_time/boot_time/process/all")
parser.add_argument ("-f", "--format", type = str, required = True, help = "Choose between text or json")
